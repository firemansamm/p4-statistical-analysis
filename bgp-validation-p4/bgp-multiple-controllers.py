...
class SimpleTopo(Topo):
    ...
    def __init__(self):
        ...
        if USE_P4_MONITOR:
            ...
            routers.append(self.addSwitch('R12', cls=OVSKernelSwitch))
        ...
        if USE_P4_SENTINEL:
            ...
            routers.append(self.addSwitch('R88', cls=OVSKernelSwitch))
...
def main():
    ...
    #os.system("cd p4_controllers; python R8_sentinel.py > ../controller_logs/R8_sentinel_logs.log 2>&1 &")     
